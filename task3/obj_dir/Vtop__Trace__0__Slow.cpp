...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,"tick", false,-1);
    tracep->declBus(c+6,"dout", false,-1, 7,0);
    tracep->pushNamePrefix("clktickr ");
    tracep->declBus(c+9,"WIDTH", false,-1, 31,0);
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+3,"rst", false,-1);
    tracep->declBit(c+2,"en", false,-1);
    ...
    tracep->declBit(c+3,"rst", false,-1);
    tracep->declBus(c+6,"dout", false,-1, 7,0);
    tracep->declBus(c+8,"num", false,-1, 7,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+7,(vlSelf->top__DOT__clktickr__DOT__count),16);
    bufp->fullCData(oldp+8,(vlSelf->top__DOT__fsm__DOT__num),8);
