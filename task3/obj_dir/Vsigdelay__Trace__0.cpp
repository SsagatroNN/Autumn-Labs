...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgSData(oldp+0,(vlSelf->sigdelay__DOT__readAddress),9);
        bufp->chgSData(oldp+1,(vlSelf->sigdelay__DOT__writeAddress),9);
        bufp->chgCData(oldp+2,(vlSelf->sigdelay__DOT____Vcellout__rAddrCounter__count),8);
        bufp->chgCData(oldp+3,(vlSelf->sigdelay__DOT____Vcellout__wAddrCounter__count),8);
    }
    bufp->chgBit(oldp+4,(vlSelf->clk));
    bufp->chgBit(oldp+5,(vlSelf->rst));
    bufp->chgBit(oldp+6,(vlSelf->wr));
    bufp->chgBit(oldp+7,(vlSelf->rd));
    bufp->chgSData(oldp+8,(vlSelf->offset),9);
