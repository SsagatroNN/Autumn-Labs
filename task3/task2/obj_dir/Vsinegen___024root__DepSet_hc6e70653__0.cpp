...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->dout0 = vlSelf->sinegen__DOT__sineRom__DOT__rom_array
        [vlSelf->sinegen__DOT__address0];
...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__1(Vsinegen___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->sinegen__DOT__address0 = 0U;
    } else {
        vlSelf->sinegen__DOT__address1 = (0xffU & ((IData)(vlSelf->sinegen__DOT__address1) 
                                                   + (IData)(vlSelf->en)));
        vlSelf->sinegen__DOT__address0 = (0xffU & ((IData)(vlSelf->sinegen__DOT__address0) 
                                                   + (IData)(vlSelf->en)));
    }
}
